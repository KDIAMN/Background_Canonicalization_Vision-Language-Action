"""
run_libero_pro.py  —  LIBERO-PRO Environment Perturbation (libero_object_temp)
...
Run:
    ...
    /path/to/VLA_Adapter/vla_adapter_env/bin/python run_libero_pro.py \
...
# perturbed suite는 원본 학습 suite의 unnorm_key 사용
UNNORM_KEY_MAP = {
    "libero_object_temp": "libero_object",
}

DEFAULT_RESULT_ROOT = "/path/to/VLA_Adapter/eval/libero_pro_env_object/vanilla_result"
...
class GenerateConfig:
    ...
    use_pro_version: bool = False   # action_head 의 MLPResNetBlock_Pro 사용 여부. normal/ftgdino 같은 Pro 학습 모델은 sh 에서 True 명시
...
def initialize_model(cfg):
    ...
    if cfg.model_family == "openvla":
        ...
        # sh 에서 --unnorm_key 로 명시했으면 그것 우선, 없으면 자동 매핑 사용
        if cfg.unnorm_key:
...
def run_task(cfg, task_suite, task_id, model, resize_size,
             ...
             video_dir, total_episodes, total_successes, log_file):
