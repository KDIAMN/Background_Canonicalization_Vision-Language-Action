...
def bg_masked_libero_object_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    # EEF_state and gripper_state are already split in TFRecord — no state key to unpack
    gripper_action = trajectory["action"][:, -1:]
    gripper_action = invert_gripper_actions(tf.clip_by_value(gripper_action, 0, 1))
...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    "bg_masked_libero_object": bg_masked_libero_object_transform,
